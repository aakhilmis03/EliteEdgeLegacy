$(function() {
	...
	//lattest blogs listing
	$('#market_insights_blog').slick({
	  slidesToShow:4,
	  infinite: true,
	  arrows: true,
	  autoplay:true,
	  responsive: [
		...
		//top story blogs listing
		$('#top_story_blog').slick({
			slidesToShow:3,
			infinite: true,
			arrows: true,
			autoplay:true,
		  ...
		  //latest update blogs listing
		$('#latest_update_blogs').slick({
			slidesToShow:3,
			infinite: true,
			arrows: true,
			autoplay:true,
...
function initGallery() {
	...
	// gsap.to('.hp-gallery', { opacity: 1, duration: 0.5});
	tl.to('.hp-header', { opacity: 1, duration: 0.5}, 'start');
  
	if ($('.hp-gallery')[0]) {
	  
	  tl.to('.hp-gallery-item[data-index="0"] img', { scale: 1.15, duration: 10}, 'start');
	  ...
	  $('.hp-gallery').on('beforeChange', function(event, slick, currentSlide, nextSlide) {
		var aniSlide = $('.slick-slide[data-slick-index="' + nextSlide + '"]  img');
		gsap.to(aniSlide, { scale: 1.15, duration: 10, onComplete: function() {
		  gsap.set('.slick-slide  img', {scale: 1});
		}});
	  });
	} else {
	  //gsap.to('.hp-header', { opacity: 1, duration: 0.5});
	}
 ...
 $(function(){
  $('#show-contact-holder').click(function(){
    $("#contact-pop-up").addClass("footerPopUp");
  });
  $('.close-holder').click(function(){
    $("#contact-pop-up").removeClass("footerPopUp");
  });
