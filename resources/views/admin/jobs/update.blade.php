...
<div class="card card-default">
   ...
   <div class="card-body">
      <form method="post" action="{{url('admin/jobs/update/'.$result->id)}}" enctype="multipart/form-data">
         @csrf
         <div class="row">
               <div class="col-sm-12">
                  <div class="form-group">
                     <label for="title">Job Title</label>
                     <input type="text" class="form-control" placeholder="Enter Job Title" name="title" value="{{ $result->title }}" required>
                     @error('title')
