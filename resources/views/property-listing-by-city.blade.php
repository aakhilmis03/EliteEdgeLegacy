            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-12 col-md-12">
                     <h2 class="ipt-title">Property in {{$city_data->title}}</h2>
                     <span class="ipn-subtitle text-white">{{$city_data->description}}</span>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="col-lg-12 col-md-12">
                     ...
                     <form method="get" enctype="multipart/form-data filter_form">
                        <!-- @csrf -->
                                 <div class="row">
                                    <div class="col-md-2">
                                       <select title="Select City" class="form-control propertyCity" name="city">
...
<script>
	$(document).ready(function() {
      ...
      //    $('.filter_form').attr('action',"{{url('property-in-')}}/"+ city_data );
      // });
	});
</script>
@endsection