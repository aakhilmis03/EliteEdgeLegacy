...
class BuilderController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            return redirect()->to('admin/builder/listing')->with('success','Record Added Successfully !');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->to('admin/builder/listing')->with('success','Record Updated Successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->to('admin/builder/listing')->with('success','Record Deleted successfully');
    }
}
